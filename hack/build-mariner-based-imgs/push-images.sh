...
KUBEVIRT_COMPONENTS_TO_PUSH="${KUBEVIRT_COMPONENTS:-virt-operator virt-api virt-handler virt-controller virt-launcher virt-exportproxy}"
echo "Pushing KubeVirt Components: $KUBEVIRT_COMPONENTS_TO_PUSH"

for ctr in virt-launcher virt-operator virt-api virt-handler virt-controller virt-exportproxy; do
