...
func (in *KubeVirtSpec) DeepCopyInto(out *KubeVirtSpec) {
	*out = *in
	...
	if in.VirtualizationStacks != nil {
		...
		*out = make([]VirtualizationStack, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualizationStack) DeepCopyInto(out *VirtualizationStack) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualizationStack.
func (in *VirtualizationStack) DeepCopy() *VirtualizationStack {
	if in == nil {
		return nil
	}
	out := new(VirtualizationStack)
	in.DeepCopyInto(out)
	return out
}
