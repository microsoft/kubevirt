...
func GetMemoryOverhead(vmi *v1.VirtualMachineInstance, cpuArch string, additionalOverheadRatio *string, virtstack *v1.VirtualizationProfile) resource.Quantity {
	...
	overhead.Add(resource.MustParse(virtstack.VirtLauncherConfiguration.VirtLauncherOverhead))
