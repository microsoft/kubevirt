...
func (_m *MockDomainManager) ResetVMI(_param0 *v1.VirtualMachineInstance) error {
	ret := _m.ctrl.Call(_m, "ResetVMI", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (_mr *_MockDomainManagerRecorder) FinalizeVirtualMachineMigration(arg0, arg1 interface{}) *gomock.Call {
...
func (_m *MockDomainManager) FormatError(err error) string {
	ret := _m.ctrl.Call(_m, "FormatError", err)
	ret0, _ := ret[0].(string)
	return ret0
}

func (_mr *_MockDomainManagerRecorder) FormatError(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FormatError", arg0)
}
