...
//
//	mockgen -source manager.go -package=virt_launcher_common -destination=generated_mock_manager.go
//

// Package virt_launcher_common is a generated GoMock package.
